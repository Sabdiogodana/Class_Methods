...
#for withrawal in self.withdrawals:
#print( f"Your recent withdrawal is {withrawal}.You have withdrawn a total of {sum(self.withdrawals)}")
# #Add a new method  full_statement which combines both deposits and withdrawals into one
#list ordered by date and using a for loop prints each transaction in a new line like this
...
acc=Account("Sabdio",234656)
acc.deposit(100000)
acc.withdraw(5000)
acc.transfer("Lona Atieno",2000)
acc.borrow_loans(3000)
acc.deposit(10000)
acc.deposit(500)
acc.deposit(10)
acc.deposit(100)
